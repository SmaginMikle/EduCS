...
namespace GradesTest
{
    ...
    public class UnitTest1
    {
        ...
        public void TestValidGrade()
        {
            ...
            Assert.AreEqual(grade.AssessmentDate, DateTime.Parse("01/01/2012").ToString("d"));
        ...
        public void TestBadDate()
        {
            ...
            Assert.AreNotEqual(grade.AssessmentDate, DateTime.Parse("01/01/2012").ToString("d"));
            Assert.AreEqual(grade.SubjectName, "Math");
            Assert.AreEqual(grade.Assessment, "A-");
        }
        ...
        public void TestBadAssessment()
        {
            ...
            Assert.AreEqual(grade.AssessmentDate, DateTime.Parse("01/01/2012").ToString("d"));
            Assert.AreEqual(grade.SubjectName, "Math");
            Assert.AreNotEqual(grade.Assessment, "A-");
        }
        ...
        public void TestBadSubject()
        {
            ...
            Assert.AreEqual(grade.AssessmentDate, DateTime.Parse("01/01/2012").ToString("d"));
            Assert.AreNotEqual(grade.SubjectName, "Math");
            Assert.AreEqual(grade.Assessment, "A-");
        }
    }
